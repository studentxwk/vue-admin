        ...
        <!--methods: {-->
            ...
            <!--rotating(index) { -->
                ...
                <!--if(type == 0) {-->
                    ...
                    <!--}-->
                   <!--_this.rotate_angle = this.start_rotating_degree + 360 * 10 + Math.floor(-360 * 100 / this.prize_list.length) / 200 - Math.floor(360 * 100 / this.prize_list.length) * result_index / 100;-->
    ...
    <div class="erwm">
        ...
        <div class="scan">
            ...
            <footer>
                ...
                <p @click="startRecognize">1</p>

                <p @click="startScan">2</p>

                <p @click="cancelScan">3</p>

                <p @click="closeScan">4</p>
